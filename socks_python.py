...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb  2 16:29:29 2024
...
def send_msg(self, text):
    ...
    proxies = {
        'http': 'socks5://192.168.239.1:10808',
        'https': 'socks5://192.168.239.1:10808',
    }
    return requests.post(self.url, json.dumps(json_text), headers=self.__headers, proxies=proxies).content
